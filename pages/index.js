    ...
    <>
      ...
      <main className="mt-8 mb-8 flex flex-col justify-center items-center">
        ...
        <p className={pStyles}>
          ...
          <strong className="text-red-500">cloud computing</strong>. I am also curious about the latest technologies
          such as <strong className="text-red-500">Web3</strong> and the blockchain.
        </p>
        ...
        <p className={pStyles}>
          ...
          the Vancouver restaurant scene. I also <strong className="text-red-500">consume a lot of media</strong>, such
          as movies and books, and especially enjoy intellectually challenging content.
        </p>
      </main>
      <Footer></Footer>
    </>
